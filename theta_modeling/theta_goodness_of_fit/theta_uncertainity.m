function [q2p_rho_theta, p2q_rho_theta] = theta_uncertainity(theta)

global theta_bin_size;
load('..\edges');
load('..\evaluation_pts');
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[histogram, bin] = histc(theta, edges);
q = histogram/size(theta,1)/theta_bin_size;
q = q(:);
