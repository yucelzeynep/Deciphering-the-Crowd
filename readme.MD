...
Since the entire data is quite large in size, we divided it into 15 segments (part1~part15 at apita_dataset/smooth_nonrepeating). For each segment, there is one file relating each of the below.
